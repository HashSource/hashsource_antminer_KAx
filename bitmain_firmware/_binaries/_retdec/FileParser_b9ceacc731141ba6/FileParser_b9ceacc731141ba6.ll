...
; uselistorder directives
  ...
  uselistorder i32 (i32*, i32, i32, %_IO_FILE*)* @fwrite, { 5, 2, 1, 0, 4, 3, 6 }
  uselistorder i32 (i32*, i32*, i32)* @SHA256_Update, { 4, 3, 2, 1, 0, 5 }
  uselistorder i32 (i32*, i32, i32, %_IO_FILE*)* @fread, { 5, 2, 1, 0, 4, 3, 6 }
...
; uselistorder directives
  uselistorder i32 (i8*, ...)* @printf, { 3, 2, 1, 0, 12, 11, 10, 9, 8, 7, 6, 5, 4, 16, 15, 14, 13, 17 }
  uselistorder i32 (i8*)* @puts, { 21, 26, 18, 19, 0, 8, 23, 2, 25, 1, 9, 24, 5, 11, 16, 3, 10, 15, 20, 13, 22, 6, 17, 14, 7, 4, 12, 27 }
}
