...
LABEL_109:
          if ( a2 && json_array_size(a2) != (_DWORD *)v31 )
          {
            ...
            sub_31760((int *)a1, "<validation>", 7, "%li array item(s) left unpacked", (char *)v61 - v31);
            return v8;
          }
          return 0;
        }
...
LABEL_68:
          ...
          sub_31760((int *)a1, "<format>", 9, "Expected ']' after '%c', got '%c'", v30, v35);
          return -1;
        }
        while ( strchr("{[siIbfFOon", v30) )
        {
          if ( a2 )
          {
            ...
            {
              v8 = -1;
              sub_31760((int *)a1, "<validation>", 17, "Array index %lu out of range", v31);
              return v8;
            }
          }
          else
...
LABEL_102:
        ...
        v8 = -1;
        sub_31760((int *)a1, v60, 9, v59, v78);
      }
      return v8;
    case 'b':
      if ( !a2 )
...
LABEL_25:
            ...
            v8 = -1;
            sub_31760((int *)a1, "<format>", 9, "Expected '}' after '%c', got '%c'", v9, v17);
          }
          else
          {
            while ( 1 )
...
LABEL_148:
      if ( v65 )
      {
        ...
        sub_31760((int *)a1, "<validation>", 7, "%li object item(s) left unpacked: %s", v65, v72);
        v8 = -1;
