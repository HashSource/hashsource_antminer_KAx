__int64 __fastcall sub_B279C(int a1, char a2, char a3, void *a4, size_t n)
{
  ...
  do
  {
    ...
    v301 = v69[1] ^ HIDWORD(qword_EE948[v310]) ^ (__CFADD__((_DWORD)v164, 161) + HIDWORD(v164)) ^ v70;
    ...
    v456 = &dword_EF148[2 * HIBYTE(v236)];
    v451 = &dword_EF148[2 * HIBYTE(v291)];
    v453 = (char *)&unk_F0940 + 8 * HIBYTE(v302);
    v464 = &dword_EF148[2 * HIBYTE(v244)];
    v472 = &dword_EF148[2 * HIBYTE(v189)];
    v488 = &dword_EF148[2 * HIBYTE(v249)];
    v446 = &dword_EF148[2 * HIBYTE(v223)];
    ...
    v120 = *((_DWORD *)v352 - 1) ^ HIDWORD(qword_EE948[v224]) ^ v393[1];
    v212 = BYTE1(v297);
    v225 = BYTE2(v467);
    ...
    HIDWORD(v128) = dword_F2148[2 * v195 + 1] ^ HIDWORD(qword_EE948[v234]) ^ v446[1] ^ *((_DWORD *)v364 - 1);
    v146 = dword_F2148[2 * v195] ^ LODWORD(qword_EE948[v234]) ^ dword_EF148[2 * v335] ^ *((_DWORD *)v364 - 2);
    v365 = v142;
    v196 = &dword_F1948[2 * v142];
    v338 = dword_F2148[2 * v226 + 1];
    v147 = v167[1] ^ HIDWORD(qword_EE948[v213]) ^ v451[1];
    v168 = BYTE2(v219);
    v178 = BYTE1(v219);
    v148 = BYTE2(v219);
    v220 = dword_F2148[2 * v226];
    v181 = &dword_F2148[2 * v148];
