int __fastcall sub_263DC(_DWORD *a1, int a2)
{
  bool v4; // zf
  int v5; // r5
  __int64 v6; // kr00_8
  ...
  *(_DWORD *)v56 = 0;
  ...
  else
  {
    ...
    if ( total_pools )
    {
      sub_24644(a1, 1, 7, *(const char **)(a2 + 8));
      v51 = json_array();
      if ( total_pools > 0 )
      {
        v6 = 0;
        do
        {
          ...
          *(_DWORD *)v56 = 0;
          ...
          sub_12EFDC((__int64)(*(double *)(v17 + 1960) * 100.0));
          v45 = json_real();
          json_object_set_new(v18, "Difficulty Accepted", v45);
          sub_12EFDC((__int64)(*(double *)(v17 + 1968) * 100.0));
          v46 = json_real();
          json_object_set_new(v18, "Difficulty Rejected", v46);
          sub_12EFDC((__int64)(*(double *)(v17 + 1816) * 100.0));
          v47 = json_real();
          json_object_set_new(v18, "Difficulty Stale", v47);
          sub_12EFDC((__int64)(*(double *)(v17 + 1624) * 100.0));
          v48 = json_real();
