int __fastcall sub_2A234(_DWORD *a1, const char **a2)
{
  char *v4; // r6
  int v5; // r8
  ...
  if ( a2 )
  {
    ...
    *((float *)&v12 + 1) = v49;
    ...
    if ( v44 > 0 )
    {
      ...
      if ( v44 > 0 )
      {
        ...
        do
        {
          ...
          v41 = v44;
          v39 += 216;
          *(_DWORD *)&v4[4 * v38++] = *(_DWORD *)(*(_DWORD *)v37 + 232);
        }
        while ( v41 > v38 );
      }
    }
    ...
    if ( v17 )
      ...
      v18 = *((float *)&v12 + 1);
    LODWORD(v19) = sub_12EFDC((__int64)(v18 * v10 * 100.0));
    v20 = v19 / 100.0;
    v21 = json_real();
    ...
    v28 = v42;
    if ( opt_algo == 9 )
      LODWORD(v28) = sub_12F2F4(v42, 0x3E8u);
    v29 = json_integer(v28);
    json_object_set_new(v9, "hw_all", v29);
    v30 = json_integer(*(__int64 *)&dword_1740B8);
