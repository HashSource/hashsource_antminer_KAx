int __fastcall phy_internal_bist_rvn(int a1, int a2, unsigned int a3, int a4)
{
  ...
  zlog(g_zc, v10, 174, "phy_internal_bist_rvn", 21, 870, 20, v56);
  v30 = malloc(0x300u);
  ...
  if ( check_core_reg_with_expect_data_rvn_0(a1, a2, a3, 125, 0x70007000u) )
  {
    ...
    zlog(
      ...
      "_godminer-new/backend/backend_rvn_2020/backend_rvn_phy_set.c",
      174,
      "phy_internal_bist_rvn",
      21,
      902,
  ...
  if ( check_core_reg_with_expect_data_rvn_0(a1, a2, a3, 83, 0) )
  {
    ...
    zlog(g_zc, v14, 174, "phy_handshake_rvn", 17, 827, 100, v56);
  }
