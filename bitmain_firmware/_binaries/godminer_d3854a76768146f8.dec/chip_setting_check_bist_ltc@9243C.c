int __fastcall chip_setting_check_bist_ltc(int a1, int a2, int a3, int a4, int *a5)
{
  ...
  V_LOCK();
  LOWORD(v11) = 2368;
  HIWORD(v11) = (unsigned int)"1746" >> 16;
  ...
  V_LOCK();
  LOWORD(v20) = 588;
  HIWORD(v20) = (unsigned int)": get test = %d" >> 16;
