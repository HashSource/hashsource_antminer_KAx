int __fastcall softreset_all_chip_kas(int a1)
{
  ...
  v9 = 3;
  v10 = 0;
  (*(void (__fastcall **)(int, int *))(a1 + 248))(a1, &v9);
  do
  {
    ...
    v21 = 0;
    v22 = 13171;
    v3 = pthread_mutex_lock((pthread_mutex_t *)(a1 + 912));
    do
    {
      v4 = dev_ctrl(v3);
      v3 = ((int (__fastcall *)(_DWORD))v4[17])(*(_DWORD *)(a1 + 228));
    }
    while ( v3 <= 0x35 );
    v5 = dev_ctrl(v3);
    ((void (__fastcall *)(_DWORD, int *, int))v5[13])(*(_DWORD *)(a1 + 228), &v9, 54);
