int __fastcall hardware_init(int a1)
{
  ...
  if ( v62[0] > 0 )
  {
    ...
    do
    {
      ...
      *(_DWORD *)(*(_DWORD *)v13 + 304) = (unsigned __int16)__rev16(LOWORD(v61[0]));
      ...
      *(_DWORD *)(v24 + 388) = platform_get_sensor_max_uneffective_count(v11++);
    }
    while ( v11 < v62[0] );
  }
  free(v4);
...
LABEL_29:
  ...
  if ( v60 > 0 )
  {
    ...
    do
    {
      ...
      v56 = *((_DWORD *)v55 + 1);
      v55 += 4;
      logfmt_raw((char *)v62, 0x1000u, 0, "chain[%d] %s", v40, v56 + 296);
      V_UNLOCK();
      zlog(
        g_zc,
        "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-orig"
      ...
      V_LOCK();
      v59 = v40++;
      logfmt_raw((char *)v62, 0x1000u, 0, "chain[%d] %x", v59, *(_DWORD *)(*(_DWORD *)v55 + 304));
      V_UNLOCK();
      zlog(
        g_zc,
        "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-orig"
