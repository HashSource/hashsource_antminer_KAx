...
LABEL_7:
  ...
  if ( v8 )
  {
    ...
    V_UNLOCK();
    LOWORD(v13) = -9656;
    HIWORD(v13) = (unsigned int)"t_kas" >> 16;
    zlog(g_zc, v13, 174, "phy_eq_main_set", 15, 1492, 60, v28);
  }
LABEL_13:
...
LABEL_19:
  ...
  if ( v17 )
  {
    ...
    V_UNLOCK();
    LOWORD(v22) = -9656;
    HIWORD(v22) = (unsigned int)"t_kas" >> 16;
    zlog(g_zc, v22, 174, "phy_eq_main_set", 15, 1512, 60, v28);
  }
LABEL_25:
  free(v4);
  return 0;
