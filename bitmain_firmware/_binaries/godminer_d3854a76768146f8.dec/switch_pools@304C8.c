  ...
  if ( total_pools > 0 )
  {
    ...
    while ( 1 )
    {
      ...
      while ( 1 )
      {
        ...
        {
          V_LOCK();
          HIWORD(v4) = (unsigned int)"ed(%d): %s" >> 16;
          logfmt_raw(v17, 0x1000u, 0, v4, v6);
          V_UNLOCK();
          zlog(*(_DWORD *)v2, v16, 134, "priority_pool", 13, 252, 100, v17);
...
LABEL_11:
  ...
  result = zlog(*(_DWORD *)v2, v13, 134, "switch_pools", 12, 364, 40, v0);
  if ( (_DWORD *)v1 != v12 )
  {
