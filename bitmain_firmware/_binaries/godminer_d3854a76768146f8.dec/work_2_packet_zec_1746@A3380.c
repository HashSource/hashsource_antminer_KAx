int __fastcall work_2_packet_zec_1746(int a1, _QWORD *a2, _BYTE *a3, _DWORD *a4)
{
  ...
  *(_BYTE *)(v6 + 27648) = (v18 + 1) & 0x7F;
  if ( !memcmp(&last_header_zec, v9, 0x8Cu) )
  {
    V_LOCK();
    LOWORD(v22) = -21168;
    HIWORD(v22) = (unsigned int)"ase_all_phy" >> 16;
    logfmt_raw(v25, 0x1000u, 0, v22);
    V_UNLOCK();
    LOWORD(v23) = 14760;
    HIWORD(v23) = (unsigned int)"ild/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/device/hal/platform/7007/7007_ui.c" >> 16;
