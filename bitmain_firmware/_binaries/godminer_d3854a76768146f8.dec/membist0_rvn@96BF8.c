int __fastcall membist0_rvn(int a1)
{
  ...
  do
  {
    ...
    do
    {
      sub_931E4(a1, v22, 28, 1);
      sub_931E4(a1, v22, 160, 3);
      usleep((__useconds_t)&loc_61A80);
      v3 = ptr;
      v4 = sub_934FC(a1, (unsigned __int16)v22, 161, ptr);
      if ( v4 > 0 )
      {
        v5 = &ptr[12 * v4];
        do
...
LABEL_10:
      v6 = ptr;
      v7 = sub_934FC(a1, (unsigned __int16)v22, 162, ptr);
      if ( v7 > 0 )
      {
        v8 = &ptr[12 * v7];
        do
...
LABEL_16:
      v9 = ptr;
      v10 = sub_934FC(a1, (unsigned __int16)v22, 163, ptr);
      if ( v10 > 0 )
      {
        v11 = &ptr[12 * v10];
        do
