int __fastcall sub_6EDC8(_DWORD *a1, int a2, int a3, _DWORD *a4, _DWORD *a5)
{
  char v5; // r8
  ...
  v18 = a3 | 0x1980000;
  BYTE1(v20) = a2;
  v9 = (int (__fastcall *)(_DWORD *, int *))a1[62];
  HIWORD(v20) = 255;
  if ( v9(a1, &v18) )
    return 0;
  usleep(0xC350u);
  ...
  *a5 = 0;
  ...
  BYTE1(v20) = v5;
  v13 = v12;
  v14 = (void (__fastcall *)(_DWORD *, int *, signed int, unsigned __int8 *, int *))a1[67];
  HIWORD(v20) = 255;
