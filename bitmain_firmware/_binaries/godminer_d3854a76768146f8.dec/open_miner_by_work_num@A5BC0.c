int __fastcall open_miner_by_work_num(int a1)
{
  ...
  V_UNLOCK();
  LOWORD(v3) = 14760;
  HIWORD(v3) = (unsigned int)"ild/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/device/hal/platform/7007/7007_ui.c" >> 16;
  zlog(g_zc, v3, 171, "open_miner_by_work_num", 22, 663, 20, dest);
  LOWORD(v4) = 9628;
  HIWORD(v4) = (unsigned int)"tage response: vol = %d." >> 16;
