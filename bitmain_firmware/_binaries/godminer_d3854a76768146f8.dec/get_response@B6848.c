int __fastcall get_response(int a1)
{
  ...
  snprintf(v2, 0x40u, "%.10s_%d", "get_response", *(_DWORD *)(a1 + 228));
  V_LOCK();
  v3 = syscall(224);
  ...
  {
    v8 = dev_ctrl((int)v7);
    v9 = ((int (__fastcall *)(_DWORD, char *, int))v8[15])(*(_DWORD *)(a1 + 228), s, 256);
    v10 = v9;
    if ( *(_BYTE *)(a1 + 861) )
      break;
    if ( v9 <= 0 )
    ...
    {
      v5 = 64;
      if ( !queue_enqueue(*(_DWORD *)(a1 + 832), s, v9) && v4 <= ++v6 )
      {
        V_LOCK();
