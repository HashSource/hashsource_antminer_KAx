int __fastcall scanhash(int a1)
{
  ...
  v23 = 1;
  v5 = *(_DWORD *)(a1 + 832);
  v6 = calloc(1u, *(_DWORD *)(a1 + 808));
  v22 = 0;
  v7 = (char *)calloc(1u, *(_DWORD *)(a1 + 812));
  while ( 1 )
  {
    memset(s, 0, sizeof(s));
...
LABEL_5:
    ...
    v10 = *(unsigned __int8 *)(a1 + 860);
    if ( *(_BYTE *)(a1 + 860) )
      break;
    memset(v6, *(unsigned __int8 *)(a1 + 860), *(_DWORD *)(a1 + 808));
    v26 = v10;
    v27 = v10;
    v25 = v10;
    ...
    if ( v11 == 10 )
    {
      if ( !queue_enqueue(*(_DWORD *)(a1 + 840), s, v24 + 3) && v23 <= ++v22 )
      {
        V_LOCK();
        logfmt_raw(
          v29,
    ...
    else if ( !v11 && *(_BYTE *)(a1 + 238) )
    {
      if ( !*(_BYTE *)(a1 + v27 + 512) && v25 && platform_check_repeat_nonce((int *)a1, v26, v7) )
      {
        ++*(_QWORD *)(*(_DWORD *)(a1 + 432) + 48 * v26 + 32);
      }
      else
      {
        ...
        {
          v13 = v26;
          v14 = (_QWORD *)(*(_DWORD *)(a1 + 432) + 8 * v12 + 48 * v26);
          ++*v14;
          if ( v12 <= 1 )
          {
            v15 = *(_QWORD *)(a1 + 424) + 1LL;
            ++*(_DWORD *)(*(_DWORD *)(a1 + 456) + 4 * v13);
            v16 = v27;
            *(_QWORD *)(a1 + 424) = v15;
            ++*(_QWORD *)(a1 + 8 * v16 + 544);
            if ( !v12
              && !*(_BYTE *)(a1 + v16 + 512)
              && !queue_enqueue(*(_DWORD *)(*(_DWORD *)(a1 + 844) + 836), (char *)v6, 1)
              && v21 <= ++v4 )
            {
              V_LOCK();
              logfmt_raw(
