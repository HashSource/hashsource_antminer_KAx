  ...
  else
  {
    ...
    if ( !start_heartbeat_thread() )
    {
      ...
      do
      {
        ...
        if ( v47 > 0 )
        {
          ...
          for ( i = 0; i < v47; ++i )
          {
            ...
            v11 = v9[1];
            ++v9;
            v12 = pthread_mutex_lock(v11 + 38);
            do
            {
              v13 = dev_ctrl(v12);
              v12 = (*(int (__fastcall **)(int))(v13 + 68))((*v9)[9].__kind);
            }
            while ( v12 <= 0x35 );
            v14 = dev_ctrl(v12);
            (*(void (__fastcall **)(int, _DWORD *, int))(v14 + 52))((*v9)[9].__kind, v49, 54);
            pthread_mutex_unlock(*v9 + 38);
          }
        }
        --v8;
      }
          ...
          if ( !v17 )
          {
            ...
            do
            {
              ...
              (*(void (__fastcall **)(_DWORD, _DWORD, _DWORD))(v19 + 24))(
                ...
                *(_DWORD *)(*v15 + 944),
                *(_DWORD *)(*v15 + 968));
              v20 = (*(int (**)(void))(*v15 + 204))();
              v17 = (*(int (**)(void))(*v15 + 216))();
              if ( !v20 )
                break;
              --v18;
            }
      ...
      else
      {
        ...
        V_LOCK();
        logfmt_raw((char *)v49, 0x1000u, 0, "check bringup temperature %d C", *(_DWORD *)(a1 + 92));
        V_UNLOCK();
        zlog(
          g_zc,
          "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-or"
        ...
        if ( v48 > 0 )
        {
          ...
          else
          {
            ...
            do
            {
              ...
              v46 = *(_DWORD *)v24;
              v24 += 4;
              (*(void (__fastcall **)(_DWORD))(v45 + 28))(*(_DWORD *)(v46 + 228));
            }
            while ( v43 != v24 );
          }
          power_off();
...
LABEL_34:
        ...
        v32 = (*(int (__fastcall **)(int))(a1 + 44))(a1);
        if ( v47 > 0 )
        {
          v33 = v4 - 1;
          v34 = v21 - 1;
        ...
        if ( !v32 )
        {
          v32 = (*(int (__fastcall **)(int, _DWORD))(a1 + 40))(a1, *(_DWORD *)(a1 + 84));
          if ( !v32 && v47 > 0 )
          {
            v39 = v21 - 1;
            for ( k = 0; k < v47; ++k )
