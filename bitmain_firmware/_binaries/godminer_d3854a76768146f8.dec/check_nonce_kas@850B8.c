...
LABEL_13:
    HIWORD(v25) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/rel"
                                "ease/build/godminer-origin_godminer-new/backend/backend_kas_2380/backend_kas_2380.c" >> 16;
    zlog(v24, v25, 171, "check_nonce_kas", 15, v23, 20, v35);
    return 2;
  }
  v6 = *(_DWORD *)(a1 + 800);
  v7 = (char *)&v31 + 3;
