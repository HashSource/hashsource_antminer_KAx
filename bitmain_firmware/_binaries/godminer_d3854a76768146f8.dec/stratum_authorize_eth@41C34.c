int __fastcall stratum_authorize_eth(int a1, int *a2)
{
  ...
  {
    V_LOCK();
    logfmt_raw((char *)v27, 0x1000u, 0, 1263860, a2[6]);
    V_UNLOCK();
    zlog(
      g_zc,
  ...
  V_LOCK();
  logfmt_raw((char *)v27, 0x1000u, 0, 1263724);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  V_LOCK();
  logfmt_raw((char *)v27, 0x1000u, 0, 1263820);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_g"
...
LABEL_4:
  ...
  if ( !v13 )
  {
    V_LOCK();
    v9 = 0;
    logfmt_raw((char *)v27, 0x1000u, 0, 1259696, s[0], v26);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-origin"
