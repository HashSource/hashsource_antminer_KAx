char *print_summary()
{
  ...
  LODWORD(v2) = sub_12EFDC(total_accepted);
  v3 = v2 / v0 * 60.0;
  ...
  zlog(
    ...
    v36);
  V_LOCK();
  logfmt_raw(v36, 0x1000u, 0, "Total got job from pools: %lld", total_getworks, dword_18B2FC);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_g"
  ...
  zlog(
    ...
    v36);
  V_LOCK();
  logfmt_raw(v36, 0x1000u, 0, "Solved blocks: %d", dword_1740A8);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_g"
  ...
  zlog(
    ...
    v36);
  V_LOCK();
  logfmt_raw(v36, 0x1000u, 0, "Rejected shares: %lld", total_rejected, dword_18B314);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_g"
  ...
  if ( total_accepted || *(_QWORD *)&total_rejected )
  {
    ...
    LODWORD(v18) = sub_12EFDC(100LL * *(_QWORD *)&total_rejected);
    HIDWORD(v18) = v17;
    LODWORD(v19) = sub_12EFDC(v16 + total_accepted);
  ...
  zlog(
    ...
    v36);
  V_LOCK();
  logfmt_raw(v36, 0x1000u, 0, "Stale submissions discarded due to new blocks: %lld", total_stale, dword_18B2C4);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_g"
    ...
    if ( total_pools > 0 )
    {
      ...
      do
      {
        ...
        if ( *((_QWORD *)v21 - 1) || *(_QWORD *)v21 )
        {
          ...
          v22 = *v21;
          v23 = v21[1];
          LODWORD(v25) = sub_12EFDC(100LL * *(_QWORD *)v21);
          HIDWORD(v25) = v24;
          LODWORD(v26) = sub_12EFDC(__PAIR64__(v23, v22) + *((_QWORD *)v21 - 1));
