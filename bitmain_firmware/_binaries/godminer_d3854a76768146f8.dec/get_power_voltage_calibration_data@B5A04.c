int get_power_voltage_calibration_data()
{
  ...
  if ( v0 )
  {
    ...
    if ( POWER_CRC16((int)v34, 30) == v2 )
    {
      ...
      V_LOCK();
      LOWORD(v6) = 27228;
      HIWORD(v6) = (unsigned int)&unk_15875C >> 16;
      logfmt_raw(v41, 0x1000u, v1, v6, "get_power_voltage_calibration_data", &v29);
      V_UNLOCK();
      LOWORD(v7) = 26444;
      HIWORD(v7) = (unsigned int)"ZcashPoW" >> 16;
      zlog(g_zc, v7, 173, "get_power_voltage_calibration_data", 34, 1070, 100, v41);
      v8 = v36;
      ...
      if ( (unsigned int)(v5 - 1) > 0xFE )
      {
        ...
        V_UNLOCK();
        LOWORD(v14) = 26444;
        HIWORD(v14) = (unsigned int)"ZcashPoW" >> 16;
        zlog(g_zc, v14, 173, "get_power_voltage_calibration_data", 34, 1094, 100, v41);
        return -1;
      }
      v16 = 255.0 / (double)v5;
      v17 = (__int16)(v36[0] + (v35 << 8));
...
LABEL_16:
    ...
    else
    {
      V_LOCK();
      LOWORD(v27) = 27216;
      HIWORD(v27) = (unsigned int)&unk_158750 >> 16;
      logfmt_raw(v41, 0x1000u, v1, v27, "get_power_voltage_calibration_data");
      V_UNLOCK();
      LOWORD(v28) = 26444;
      HIWORD(v28) = (unsigned int)"ZcashPoW" >> 16;
      zlog(g_zc, v28, 173, "get_power_voltage_calibration_data", 34, 1055, 100, v41);
      return -1;
    }
  }
  else
  {
    V_LOCK();
    LOWORD(v24) = 27184;
    HIWORD(v24) = (unsigned int)&unk_158730 >> 16;
    logfmt_raw(v41, 0x1000u, 0, v24, "get_power_voltage_calibration_data");
    V_UNLOCK();
    LOWORD(v25) = 26444;
    HIWORD(v25) = (unsigned int)"ZcashPoW" >> 16;
    zlog(g_zc, v25, 173, "get_power_voltage_calibration_data", 34, 1034, 100, v41);
    return -1;
  }
}
