int *__fastcall sub_D61D4(int *a1, int a2, int *a3)
{
  int *v3; // r7
  unsigned int v4; // r4
  int *v5; // r8
  ...
  do
  {
    ...
    sub_D454C(v107, &v107[16]);
    sub_D454C(&v107[16], v107);
    v26 = v25 + 128;
    v25 += 256;
  ...
  *a3 = 1779033703;
  ...
  memset(v106, 54, 32);
  sub_D495C(&v78, &v98, 0);
  sub_D495C(&v78, v107, 1);
  sub_D495C(&v78, &v107[16], 1);
  sub_D495C(&v78, dword_1587A4, 0);
  v98 = v78;
  v99 = v79;
  v100 = v80;
  v101 = v81;
