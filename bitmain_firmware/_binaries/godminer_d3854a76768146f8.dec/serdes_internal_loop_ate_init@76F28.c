int __fastcall serdes_internal_loop_ate_init(int a1, unsigned int a2, int a3, int a4)
{
  ...
  V_UNLOCK();
  LOWORD(v12) = -9656;
  HIWORD(v12) = (unsigned int)"t_kas" >> 16;
  zlog(g_zc, v12, 174, "serdes_internal_loop_ate_init", 29, 158, 60, v41);
  ...
  LOWORD(v10) = -9384;
  zlog(g_zc, v14, 174, "serdes_internal_loop_ate_init", 29, 162, 60, v41);
  ...
  zlog(g_zc, v16, 174, "serdes_internal_loop_ate_init", 29, 172, 60, v41);
  ...
  V_UNLOCK();
  LOWORD(v21) = -9656;
  HIWORD(v21) = (unsigned int)"t_kas" >> 16;
  zlog(g_zc, v21, 174, "serdes_internal_loop_ate_init", 29, 291, 60, v41);
