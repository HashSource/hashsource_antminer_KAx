...
LABEL_18:
  ...
  else
  {
    ...
    zlog(g_zc, v21, 139, "set_working_voltage_and_runtime_freq", 36, 1103, 100, v28);
    V_LOCK();
    LOWORD(v22) = 5520;
    LOWORD(v23) = 4752;
    HIWORD(v22) = (unsigned int)"\\b" >> 16;
    HIWORD(v23) = (unsigned int)&unk_132B50 >> 16;
    logfmt_raw(v28, 0x1000u, 0, v23, v22);
    V_UNLOCK();
    LOWORD(v24) = 4232;
    HIWORD(v24) = (unsigned int)&unk_132994 >> 16;
    zlog(g_zc, v24, 139, "set_working_voltage_and_runtime_freq", 36, 1104, 100, v28);
    return -1;
  }
  return result;
}
