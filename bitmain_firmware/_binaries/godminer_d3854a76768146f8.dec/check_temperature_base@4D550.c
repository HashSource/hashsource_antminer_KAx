        ...
        while ( 1 )
        {
          ...
          if ( *v14 != -64 )
          {
            ...
            if ( !v17 )
            {
              ...
              *((_DWORD *)v18 - 128) = v16;
              V_LOCK();
              V_INT((int)v48, "chain", *(int *)(all_created_runtime[v15] + 232));
              logfmt_raw(
                v60,
                0x1000u,
                0,
...
LABEL_22:
            ...
            if ( v17 == 1 )
            {
              ...
              *((_DWORD *)v37 - 64) = v16;
              V_LOCK();
              V_INT((int)v50, "chain", *(int *)(all_created_runtime[v15] + 232));
              logfmt_raw(
                v60,
                0x1000u,
                0,
...
LABEL_38:
        ...
        while ( 1 )
        {
          ...
          if ( !v29 )
          {
            ...
            {
              V_LOCK();
              V_INT((int)v54, "chain", *(int *)(*v40 + 232));
              logfmt_raw(
                v60,
                0x1000u,
                0,
          ...
          if ( v29 == 1 )
          {
            ...
            {
              V_LOCK();
              V_INT((int)v56, "chain", *(int *)(*v40 + 232));
              logfmt_raw(
                v60,
                0x1000u,
                0,
...
LABEL_29:
        ...
        V_LOCK();
        V_INT((int)v52, "chain", *(int *)(*v40 + 232));
        logfmt_raw(
          v60,
          0x1000u,
          0,
