int task_check_miner_status()
{
  ...
  __int64 v154; // [sp+290h] [bp-111Ch] BYREF
  int v155; // [sp+298h] [bp-1114h]
  int v156; // [sp+29Ch] [bp-1110h]
  int v157; // [sp+2A0h] [bp-110Ch]
  int v158; // [sp+2A4h] [bp-1108h]
  int v159; // [sp+2A8h] [bp-1104h]
  int v160; // [sp+2ACh] [bp-1100h]
  _DWORD v161[7]; // [sp+2B0h] [bp-10FCh] BYREF
  int v162; // [sp+2CCh] [bp-10E0h]
  int v163; // [sp+2D0h] [bp-10DCh] BYREF
  int v164; // [sp+2D4h] [bp-10D8h]
  int v165; // [sp+2D8h] [bp-10D4h] BYREF
  int v166; // [sp+2DCh] [bp-10D0h]
  int v167; // [sp+2E0h] [bp-10CCh]
  int v168; // [sp+2E4h] [bp-10C8h]
  int v169; // [sp+2E8h] [bp-10C4h]
  int v170; // [sp+2ECh] [bp-10C0h]
  float v171; // [sp+2F0h] [bp-10BCh]
  float v172; // [sp+2F8h] [bp-10B4h]
  float v173; // [sp+2FCh] [bp-10B0h]
  _DWORD v174[1025]; // [sp+3A8h] [bp-1004h] BYREF
  ...
  all_created_runtime = (char *)get_all_created_runtime(v161);
  v163 = 0;
  v164 = 0;
  v165 = 0;
  if ( v161[0] <= 0 )
...
LABEL_15:
      ...
      *v37 = v149[4];
      ...
      v37[2] = v39;
      v37[3] = v40;
      logfmt_raw((char *)v174, 0x1000u, 0, v151, v150[0], v150[1], v150[2], v150[3], v150[4], v150[5], v150[6], v151);
      V_UNLOCK();
      zlog(
        g_zc,
...
LABEL_111:
        V_LOCK();
        v85 |= 2u;
        V_INT((int)v147, v110, *(int *)(*(_DWORD *)v96 + 232));
        ...
        *v57 = v146[4];
        ...
        v57[2] = v59;
        v57[3] = v60;
        logfmt_raw((char *)v174, 0x1000u, 0, v148, v147[0], v147[1], v147[2], v147[3], v147[4], v147[5], v147[6], v148);
        V_UNLOCK();
        zlog(
          g_zc,
...
LABEL_113:
      ...
      v124 = v85 | 4;
      v61 = v84;
      V_INT((int)v144, v110, *(int *)(*(_DWORD *)v96 + 232));
      ...
      *v65 = v143[4];
      ...
      v65[2] = v67;
      v65[3] = v68;
      logfmt_raw((char *)v174, 0x1000u, 0, v145, v144[0], v144[1], v144[2], v144[3], v144[4], v144[5], v144[6], v145);
      V_UNLOCK();
      zlog(
        g_zc,
        "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-orig"
...
LABEL_115:
      ...
      v69 = *(_DWORD *)v96;
      v124 |= 8u;
      V_INT((int)v141, v110, *(int *)(v69 + 232));
      ...
      *v73 = v140[4];
      ...
      v73[2] = v75;
      v73[3] = v76;
      logfmt_raw((char *)v174, 0x1000u, 0, v142, v141[0], v141[1], v141[2], v141[3], v141[4], v141[5], v141[6], v142);
      V_UNLOCK();
      zlog(
        g_zc,
        "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-orig"
...
LABEL_117:
        V_LOCK();
        V_INT((int)v138, v110, *(int *)(*(_DWORD *)v96 + 232));
        V_STR(v137, s, v125);
        v77 = v137[1];
        v78 = v137[2];
        v79 = v137[3];
        ...
        *v80 = v137[4];
        ...
        v80[2] = v82;
        v80[3] = v83;
        logfmt_raw((char *)v174, 0x1000u, 0, v139, v138[0], v138[1], v138[2], v138[3], v138[4], v138[5], v138[6], v139);
        V_UNLOCK();
        zlog(
          g_zc,
          "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-or"
...
LABEL_36:
  v163 = 0;
  v12 = (int *)get_all_created_runtime(&v163);
  ...
  if ( v134 > 0 )
  {
    ...
    {
      v17 = *v14++;
      v15 = (unsigned __int8)(v15 & *(_BYTE *)(v17 + 238));
    }
    while ( v16 != v14 );
    v92 = v15;
  }
  ...
  if ( (int)v154 > 0 )
  {
    ...
    do
    {
      ...
      V_LOCK();
      ++v18;
      V_INT((int)v161, (char *)v95, *(int *)(*v20 + 232));
      v93 = v92;
      logfmt_raw(
        (char *)v174,
        0x1000u,
      ...
      zlog(
        ...
        80,
        v174);
      read_status_from_monitor(&v163, *v20);
      V_LOCK();
...
LABEL_87:
    ...
    v174[0] = 0;
    v97[12] = 1;
    v43 = (char *)get_all_created_runtime(v174);
    if ( v174[0] > 0 )
    {
      v44 = v43 - 4;
      do
      {
        ...
        v46 = (*(int (**)(void))(v45 + 20))();
        v47 = dev_ctrl(v46);
        (*(void (__fastcall **)(_DWORD))(v47 + 28))(*(_DWORD *)(*(_DWORD *)v44 + 228));
      }
      while ( v42 < v174[0] );
    }
    power_off();
