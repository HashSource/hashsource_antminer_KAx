...
LABEL_30:
      ...
      if ( v39 > 0 )
      {
        ...
        for ( i = 0; i < v39; ++i )
        {
          v22 = *((_DWORD *)v20 + 1);
          v20 += 4;
          if ( api_get_eeprom_fmt_version(*(_DWORD *)(v22 + 228)) == 4 )
          {
            eeprom_asic_freqs = api_get_eeprom_asic_freqs(*(_DWORD *)(*(_DWORD *)v20 + 228), &dest, &v40);
            if ( !eeprom_asic_freqs )
            {
              memset(s, 0, sizeof(s));
              v24 = *(_DWORD *)v20;
              v25 = *(_DWORD *)(*(_DWORD *)v20 + 312);
              if ( v25 )
              {
                v26 = (float *)&v43;
                v27 = dest + 0.0;
