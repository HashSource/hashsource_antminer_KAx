int __fastcall stratum_handle_response_rvn(int a1, int a2, int a3)
{
  ...
  if ( !v4 )
  {
    ...
    V_UNLOCK();
    LOWORD(v24) = 21076;
    HIWORD(v24) = (unsigned int)" to start asic" >> 16;
    zlog(g_zc, v24, 164, "stratum_handle_response_rvn", 27, 440, 40, v31);
    return 0;
  }
...
LABEL_28:
    ...
    V_UNLOCK();
    LOWORD(v18) = 21076;
    HIWORD(v18) = (unsigned int)" to start asic" >> 16;
    v16 = 0;
    zlog(g_zc, v18, 164, "stratum_handle_response_rvn", 27, 472, 20, v31);
    goto LABEL_29;
  }
LABEL_18:
  if ( *v12 == 7 )
