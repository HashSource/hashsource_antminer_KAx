  ...
  while ( 2 )
  {
    ...
    do
    {
      ...
      if ( v10 - 800 <= 0x640 )
      {
        ...
        v13 = sub_12EA10(25 * (v10 / 0x19), v7);
        v11 = (float)sub_12EA10(v13, v8);
        goto LABEL_12;
      }
...
LABEL_12:
  V_LOCK();
  LOWORD(v14) = -19176;
  HIWORD(v14) = (unsigned int)"ce/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/backend_eth_2280/backend_eth_2280.c" >> 16;
  logfmt_raw(v22, 0x1000u, 0, v14, v11, v3, v12, v19, v20, v21);
  V_UNLOCK();
  LOWORD(v15) = 2120;
  HIWORD(v15) = (unsigned int)"6" >> 16;
