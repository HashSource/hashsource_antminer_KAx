int __fastcall packet_2_nonce_ltc(_DWORD *a1, _BYTE *a2, int a3, _BYTE *a4, _DWORD *a5, int *a6, _DWORD *a7)
{
  ...
  V_LOCK();
  LOWORD(v11) = 1284;
  HIWORD(v11) = (unsigned int)&unk_152074 >> 16;
  logfmt_raw(v29, 0x1000u, 0, v11);
  V_UNLOCK();
  LOWORD(v12) = 604;
  HIWORD(v12) = (unsigned int)"dapt_rvn" >> 16;
  ...
  if ( v14 == (a2[8] & 0x1F) )
  {
    ...
    *a4 = 1;
    V_LOCK();
    LOWORD(v24) = 1376;
    HIWORD(v24) = (unsigned int)&unk_1520D0 >> 16;
    logfmt_raw(v29, 0x1000u, 0, v24);
    V_UNLOCK();
    LOWORD(v25) = 604;
    HIWORD(v25) = (unsigned int)"dapt_rvn" >> 16;
  ...
  {
    LOWORD(v26) = 1308;
    HIWORD(v26) = (unsigned int)&unk_15208C >> 16;
