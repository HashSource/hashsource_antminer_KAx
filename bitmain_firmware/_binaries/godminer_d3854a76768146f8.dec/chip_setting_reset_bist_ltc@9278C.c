int __fastcall chip_setting_reset_bist_ltc(int a1, int a2, int a3, int a4, int a5)
{
  ...
  V_LOCK();
  LOWORD(v9) = -25092;
  HIWORD(v9) = (unsigned int)"date_dash" >> 16;
  logfmt_raw(var1004, 0x1000u, 0, v9, "chip_setting_reset_bist_ltc");
  V_UNLOCK();
  LOWORD(v10) = 2120;
  HIWORD(v10) = (unsigned int)"6" >> 16;
...
LABEL_21:
        ...
        V_LOCK();
        LOWORD(v24) = 1764;
        HIWORD(v24) = (unsigned int)&unk_152254 >> 16;
...
LABEL_8:
    ...
    V_LOCK();
    LOWORD(v16) = 1764;
    HIWORD(v16) = (unsigned int)&unk_152254 >> 16;
