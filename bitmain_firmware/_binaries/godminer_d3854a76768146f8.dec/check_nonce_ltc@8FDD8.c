int __fastcall check_nonce_ltc(int a1, int a2)
{
  ...
  if ( v6 <= 0x1A )
  {
    V_LOCK();
    LOWORD(v21) = 1044;
    HIWORD(v21) = (unsigned int)&unk_151F84 >> 16;
    logfmt_raw(v26, 0x1000u, 0, v21, v7, *(unsigned __int8 *)(a2 + 84), 27);
    V_UNLOCK();
    LOWORD(v22) = 604;
    HIWORD(v22) = (unsigned int)"dapt_rvn" >> 16;
...
LABEL_13:
    LOWORD(v18) = 604;
    HIWORD(v18) = (unsigned int)"dapt_rvn" >> 16;
  ...
  if ( v6 != v8 + 16 )
  {
    V_LOCK();
    LOWORD(v23) = 1172;
    HIWORD(v23) = (unsigned int)&unk_152004 >> 16;
...
LABEL_4:
  ...
  V_LOCK();
  LOWORD(v19) = -19704;
  HIWORD(v19) = (unsigned int)"set_work_mode" >> 16;
  logfmt_raw(v26, 0x1000u, 0, v19, v7, v5);
  V_UNLOCK();
  LOWORD(v20) = 604;
  HIWORD(v20) = (unsigned int)"dapt_rvn" >> 16;
