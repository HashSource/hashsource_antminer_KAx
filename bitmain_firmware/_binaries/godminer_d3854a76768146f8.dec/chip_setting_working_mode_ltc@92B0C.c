int __fastcall chip_setting_working_mode_ltc(int a1, int a2, int a3, int a4, int a5, unsigned __int8 a6)
{
  ...
  V_LOCK();
  LOWORD(v10) = -25092;
  HIWORD(v10) = (unsigned int)"date_dash" >> 16;
  logfmt_raw(var1000, 0x1000u, 0, v10, "chip_setting_working_mode_ltc");
  V_UNLOCK();
  LOWORD(v11) = 2120;
  HIWORD(v11) = (unsigned int)"6" >> 16;
  ...
  if ( a4 )
  {
    ...
    if ( v16 )
    {
      V_LOCK();
      LOWORD(v17) = 2528;
      HIWORD(v17) = (unsigned int)"once_integrality_zec_1746" >> 16;
      logfmt_raw(
        var1000,
        0x1000u,
        0,
  ...
  else
  {
    ...
    *(_WORD *)((char *)&v27 + 1) = (unsigned __int8)v22;
    ...
    if ( v16 )
    {
      V_LOCK();
      LOWORD(v23) = 2588;
      HIWORD(v23) = (unsigned int)"er_by_work_num" >> 16;
      logfmt_raw(
        var1000,
        0x1000u,
        0,
