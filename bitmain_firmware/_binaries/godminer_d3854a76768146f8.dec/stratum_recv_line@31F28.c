char *__fastcall stratum_recv_line(pthread_mutex_t *a1)
{
  ...
  if ( !strchr(spins, 10) && a1[1].__kind != -1 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        V_LOCK();
        logfmt_raw((char *)v17, 0x1000u, 0, 1254152);
        V_UNLOCK();
        v12 = g_zc;
        v13 = 58;
        goto LABEL_20;
      ...
      if ( v10 < 0 )
      {
        V_LOCK();
        v11 = _errno_location();
        logfmt_raw((char *)v17, 0x1000u, 0, 1254184, v10, *v11);
        V_UNLOCK();
        zlog(
          g_zc,
        ...
        {
          V_LOCK();
          logfmt_raw((char *)v17, 0x1000u, 0, 1254228, *v11);
          V_UNLOCK();
          v12 = g_zc;
          v13 = 65;
LABEL_20:
...
LABEL_2:
  v4 = strlen(spins);
  v5 = strtok(spins, (const char *)&word_1316F8);
  if ( v5 )
  {
    v6 = _strdup(v5);
    v7 = strlen(v6);
    ...
    if ( opt_protocol )
    {
      ...
      logfmt_raw(v19, 0x1000u, 0, v18, v17[0], v17[1], v17[2], v17[3], v17[4], v17[5], v17[6], v18, 1254368, v6);
      V_UNLOCK();
      zlog(
        g_zc,
  ...
  {
    V_LOCK();
    logfmt_raw(v19, 0x1000u, 0, 1254304);
    V_UNLOCK();
    zlog(
      g_zc,
