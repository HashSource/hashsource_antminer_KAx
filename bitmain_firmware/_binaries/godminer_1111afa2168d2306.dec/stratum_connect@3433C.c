bool __fastcall stratum_connect(int a1)
{
  ...
  V_LOCK();
  logfmt_raw(v23, 0x1000u, 0, 1347500, *(_DWORD *)(a1 + 32), cp, v18);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  *v6 = 0;
  if ( *(_DWORD *)(a1 + 36) == -1 )
  {
    ...
    *(_DWORD *)(a1 + 36) = v10;
    if ( v10 == -1 )
    {
      V_LOCK();
      server_port_from_url = 0;
      logfmt_raw(v23, 0x1000u, 0, 1347532);
      V_UNLOCK();
      v15 = g_zc;
      v16 = 100;
      v17 = 135;
    ...
    if ( setsockopt(v10, 1, 2, optval, 4u) )
    {
      ...
      v11 = _errno_location();
      v12 = strerror(*v11);
      logfmt_raw(v23, 0x1000u, 0, 1347560, v12);
      V_UNLOCK();
      zlog(
        g_zc,
  ...
  if ( inet_addr(cp) == -1 )
  {
    if ( _res_init() < 0 )
    {
      ...
      *(_DWORD *)(a1 + 36) = -1;
      V_LOCK();
      logfmt_raw(v23, 0x1000u, 0, 1347612, *(_DWORD *)a1);
      V_UNLOCK();
      v15 = g_zc;
      v16 = 100;
      v17 = 160;
    ...
    else
    {
      ...
      *(_DWORD *)(a1 + 36) = -1;
      V_LOCK();
      logfmt_raw(v23, 0x1000u, 0, 1347640);
      V_UNLOCK();
      v15 = g_zc;
      v16 = 20;
      v17 = 169;
  ...
  *(_WORD *)addr.sa_data = __rev16(v18);
  ...
  else
  {
    if ( dword_1964A4 <= 3 )
    {
      ...
      v8 = _errno_location();
      v9 = strerror(*v8);
      logfmt_raw(v23, 0x1000u, 0, 1347664, v9);
      V_UNLOCK();
      zlog(
        g_zc,
        "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-orig"
