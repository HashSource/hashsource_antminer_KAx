...
LABEL_24:
    v24 = g_zc;
    LOWORD(v25) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp"
...
LABEL_14:
  ...
  *(_BYTE *)(a2 + 444) = 1;
  ...
  LOWORD(v25) = -18936;
LABEL_25:
  HIWORD(v25) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/relea"
                              "se/build/godminer-origin_godminer-new/frontend/frontend_eth_2282/frontend_eth_2282.c" >> 16;
  zlog(v24, v25, 174, "stratum_notify_eth_2282", 23, v23, 100, v29);
  pthread_mutex_unlock((pthread_mutex_t *)(a2 + 1592));
  return 0;
}
