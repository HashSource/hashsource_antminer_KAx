int __fastcall recover_mining_eth(int a1)
{
  ...
  if ( eeprom_phy_seq_level > 0xA )
  {
    ...
    LOWORD(v8) = -12348;
    HIWORD(v8) = (unsigned int)"ChipSetting_get_single_chip_core_status_ETH" >> 16;
    ...
    zlog(g_zc, v9, 171, "recover_mining_eth", 18, 1866, 60, v12);
    return 31;
  }
  else
  {
