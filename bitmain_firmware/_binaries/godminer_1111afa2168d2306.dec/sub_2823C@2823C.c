      ...
      if ( total_pools > 0 )
      {
        ...
        do
        {
          ...
          *(_DWORD *)v56 = 0;
          ...
          sub_145954((__int64)(*(double *)(v17 + 1960) * 100.0));
          v45 = json_real();
          json_object_set_new(v18, "Difficulty Accepted", v45);
          sub_145954((__int64)(*(double *)(v17 + 1968) * 100.0));
          v46 = json_real();
          json_object_set_new(v18, "Difficulty Rejected", v46);
          sub_145954((__int64)(*(double *)(v17 + 1816) * 100.0));
          v47 = json_real();
          json_object_set_new(v18, "Difficulty Stale", v47);
          sub_145954((__int64)(*(double *)(v17 + 1624) * 100.0));
          v48 = json_real();
