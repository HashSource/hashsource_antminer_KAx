int __fastcall sub_4AA18(int a1, int *a2)
{
  int v2; // r7
  double *v5; // r6
  void *v6; // r9
  ...
  do
  {
    ...
    if ( !(*(int (__fastcall **)(int *, char *))(a1 + 12))(a2, v16) )
    {
      ...
      LOWORD(v9) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tm"
                                     "p/release/build/godminer-origin_godminer-new/frontend/frontend_ks5/frontend_ks5.c";
      goto LABEL_3;
    }
...
LABEL_3:
      HIWORD(v9) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/re"
                                 "lease/build/godminer-origin_godminer-new/frontend/frontend_ks5/frontend_ks5.c" >> 16;
      zlog(v8, v9, 164, "stratum_subscribe_ks5", 21, v7, 100, v32);
      free(v16);
      if ( !v5 )
        goto LABEL_11;
      goto LABEL_4;
