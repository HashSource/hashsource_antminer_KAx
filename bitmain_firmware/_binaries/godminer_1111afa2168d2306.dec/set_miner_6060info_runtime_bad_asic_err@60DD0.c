int __fastcall set_miner_6060info_runtime_bad_asic_err(int a1, int a2)
{
  ...
  if ( a1 > 15 )
  {
    ...
    v3 = 0;
    zlog(g_zc, v11, 169, "set_miner_6060info_runtime_bad_asic_err", 39, 105, 40, v13);
  }
  else
  {
    v3 = a1;
  ...
  if ( a2 )
  {
    ...
    *((_DWORD *)v4 + 7) = v13[0].tv_sec;
    if ( !v6 )
    {
      ...
      {
        LOWORD(v7) = -31980;
        HIWORD(v7) = (unsigned int)"t miner type[%d] %s" >> 16;
        ...
        zlog(g_zc, v9, 169, "set_miner_6060info_runtime_bad_asic_err", 39, 108, 100, v13);
        LOBYTE(a2) = v4[24];
      }
    }
  }
