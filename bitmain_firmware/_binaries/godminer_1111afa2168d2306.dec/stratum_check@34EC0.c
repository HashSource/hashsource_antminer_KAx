int __fastcall stratum_check(int *a1)
{
  ...
  {
    V_LOCK();
    logfmt_raw(v29, 0x1000u, 0, 1347916, *a1);
    V_UNLOCK();
    zlog(
      g_zc,
  ...
  a1[8] = (int)_strdup(v4);
  V_LOCK();
  logfmt_raw(v29, 0x1000u, 0, 1347964, *a1, a1[3]);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  if ( !(*(int (__fastcall **)(int *))v3)(a1) )
  {
    ...
    V_LOCK();
    logfmt_raw(v29, 0x1000u, 0, 1348000);
    V_UNLOCK();
    v6 = g_zc;
    v7 = 376;
LABEL_8:
...
LABEL_10:
  ...
  if ( !(*(int (__fastcall **)(int, int *))(v3 + 16))(v3, a1) )
  {
    (*(void (__fastcall **)(int *))(v3 + 4))(a1);
    V_LOCK();
    logfmt_raw(v29, 0x1000u, 0, 1348040);
    V_UNLOCK();
    v6 = g_zc;
    v7 = 383;
    goto LABEL_8;
...
LABEL_22:
    ...
    V_LOCK();
    V_INT((int)v27, s, *a1);
    logfmt_raw(v29, 0x1000u, 0, v28, v27[0], v27[1], v27[2], v27[3], v27[4], v27[5], v27[6], v28, 1347864);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-origin"
    ...
    || (*(int (__fastcall **)(int, void *, int *))(v3 + 28))(v3, v16, a1) )
  {
    ...
    (*(void (__fastcall **)(int *))(v3 + 4))(a1);
    V_LOCK();
    logfmt_raw(v29, 0x1000u, 0, 1348172, *a1, a1[3]);
    V_UNLOCK();
    v9 = g_zc;
    v10 = 40;
    v11 = 437;
LABEL_11:
  ...
  else
  {
    ...
    (*(void (__fastcall **)(int *))(v3 + 4))(a1);
    V_LOCK();
    logfmt_raw(v29, 0x1000u, 0, 1348064, *a1);
    v8 = 0;
    V_UNLOCK();
    zlog(
      g_zc,
      ...
      v29);
    V_LOCK();
    logfmt_raw(v29, 0x1000u, 0, 1348144, *a1);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-origin"
