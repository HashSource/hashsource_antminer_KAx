int __fastcall get_chain_mps_voltage(int a1, _WORD *a2)
{
  ...
  *a2 = -1;
  if ( !sub_BB4A8(a1, 0)
    || (src = 8562, v12 = 2, sub_BB0E0(a1, 60, &src, 3u, &v9, 2u))
    || (v5 = v9, v6 = v10, !sub_BB4A8(a1, 2))
    || (v12 = 2, src = 3442, (result = sub_BB0E0(a1, 60, &src, 3u, &v9, 2u)) != 0) )
  {
    V_LOCK();
    logfmt_raw((char *)&src, 0x1000u, 0, 1527592, a1);
    V_UNLOCK();
    zlog(
      g_zc,
  ...
  else
  {
    ...
    *a2 = v8;
    ...
    {
      V_LOCK();
      logfmt_raw((char *)&src, 0x1000u, 0, 1527544, v7, v8, a1);
      V_UNLOCK();
      zlog(
        g_zc,
