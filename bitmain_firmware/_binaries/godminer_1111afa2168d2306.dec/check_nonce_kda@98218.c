int __fastcall check_nonce_kda(int a1, int a2)
{
  ...
  {
    V_LOCK();
    logfmt_raw((char *)v47, 0x1000u, 0, 1507256, v14, *(unsigned __int8 *)(a2 + 88), 40, v39, src, v41);
    V_UNLOCK();
    zlog(
      g_zc,
...
LABEL_8:
    ...
    V_LOCK();
    LOWORD(v38) = -21748;
    HIWORD(v38) = (unsigned int)"design(%d<%d)" >> 16;
    logfmt_raw((char *)v47, 0x1000u, 0, v38, v14, *(unsigned __int8 *)(a2 + 88), v5, v39, src, v41);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-origin"
