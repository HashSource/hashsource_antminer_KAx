int __fastcall stratum_authorize_eth(int a1, int *a2)
{
  ...
  if ( a2[6] )
  {
    ...
    V_UNLOCK();
    LOWORD(v5) = -20336;
    HIWORD(v5) = (unsigned int)"pool job parse failed!" >> 16;
    zlog(g_zc, v5, 164, "stratum_authorize_eth", 21, 379, 20, &v48);
    v6 = (char *)a2[6];
    goto LABEL_3;
  }
  V_LOCK();
  ...
  V_UNLOCK();
  LOWORD(v17) = -20336;
  HIWORD(v17) = (unsigned int)"pool job parse failed!" >> 16;
  zlog(g_zc, v17, 164, "stratum_authorize_eth", 21, 361, 20, &v48);
  memset(s, 0, 32);
  v18 = socket(2, 1, 0);
  if ( v18 < 0 )
  {
  ...
  V_UNLOCK();
  LOWORD(v41) = -20336;
  HIWORD(v41) = (unsigned int)"pool job parse failed!" >> 16;
  zlog(g_zc, v41, 164, "stratum_authorize_eth", 21, 370, 20, &v48);
  time(&v48);
  LOWORD(v42) = 27996;
...
LABEL_4:
  ...
  if ( !v22 )
  {
    ...
    V_UNLOCK();
    LOWORD(v39) = -20336;
    HIWORD(v39) = (unsigned int)"pool job parse failed!" >> 16;
    zlog(g_zc, v39, 164, "stratum_authorize_eth", 21, 404, 100, &v48);
    free(v12);
    return v13;
  }
  LOWORD(v23) = -23456;
  ...
  else
  {
    ...
    V_UNLOCK();
    LOWORD(v34) = -20336;
    HIWORD(v34) = (unsigned int)"pool job parse failed!" >> 16;
    zlog(g_zc, v34, 164, "stratum_authorize_eth", 21, 415, 80, &v48);
  }
  free(v12);
  if ( *((_DWORD *)v22 + 1) == -1 )
    return v13;
