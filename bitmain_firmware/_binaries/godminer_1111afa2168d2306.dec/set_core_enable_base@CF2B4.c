int __fastcall set_core_enable_base(int result, int a2, __useconds_t a3)
{
  ...
  if ( *(_BYTE *)(a2 + 13) )
  {
    ...
    V_LOCK();
    LOWORD(v14) = 4220;
    HIWORD(v14) = (unsigned int)"odminer-origin_godminer-new/backend/backend_ltc_1489/chip_setting_ltc_1489.c" >> 16;
    logfmt_raw(v16, 0x1000u, 0, v14, "set_core_enable_base", *(unsigned __int16 *)(a2 + 10), v4);
    V_UNLOCK();
    LOWORD(v15) = -32276;
    HIWORD(v15) = (unsigned int)"02x" >> 16;
    zlog(g_zc, v15, 154, "set_core_enable_base", 20, 1418, 100, v16);
    return -1;
  }
  return result;
}
