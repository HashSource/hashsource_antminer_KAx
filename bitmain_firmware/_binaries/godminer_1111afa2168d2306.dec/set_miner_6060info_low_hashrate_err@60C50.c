int __fastcall set_miner_6060info_low_hashrate_err(int a1, int a2)
{
  ...
  if ( a1 > 15 )
  {
    ...
    v3 = 0;
    zlog(g_zc, v11, 169, "set_miner_6060info_low_hashrate_err", 35, 97, 40, &tv);
  }
  else
  {
    v3 = a1;
  ...
  if ( a2 )
  {
    ...
    *((_DWORD *)v4 + 7) = tv.tv_sec;
    if ( !v6 )
    {
      ...
      {
        LOWORD(v7) = -31988;
        HIWORD(v7) = (unsigned int)"il/miner_monitor/miner_monitor.c" >> 16;
        ...
        zlog(g_zc, v9, 169, "set_miner_6060info_low_hashrate_err", 35, 99, 100, &tv);
        LOBYTE(a2) = v4[24];
      }
    }
  }
