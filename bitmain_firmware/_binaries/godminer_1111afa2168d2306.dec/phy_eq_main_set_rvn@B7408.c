int __fastcall phy_eq_main_set_rvn(int a1, int a2)
{
  ...
  if ( v5 )
  {
    ...
    sub_AEC50(a1, 111, bswap32(*v6) | v3);
  }
LABEL_7:
  v8 = sub_AECE4(a1, 0, 111, v4);
  if ( v8 )
  {
    v9 = v4;
    v10 = 0;
    ...
    zlog(g_zc, v13, 174, "phy_eq_main_set_rvn", 19, 1374, 60, v28);
  }
LABEL_13:
  v14 = sub_AECE4(a1, 0, 112, v4);
  if ( v14 )
  {
    v15 = v4;
    v16 = 0;
    ...
    sub_AEC50(a1, 112, bswap32(*v15) | v3);
  }
LABEL_19:
  v17 = sub_AECE4(a1, 0, 112, v4);
  if ( v17 )
  {
    v18 = v4;
    v19 = 0;
    ...
    zlog(g_zc, v22, 174, "phy_eq_main_set_rvn", 19, 1394, 60, v28);
  }
LABEL_25:
  free(v4);
  return 0;
