int __fastcall packet_2_nonce_kas(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, signed int *a6, _DWORD *a7)
{
  ...
  if ( v11 != v13 && *(_BYTE *)(a1 + 265) )
  {
    ...
    if ( v29 <= 9 )
    {
      ...
      V_UNLOCK();
      LOWORD(v32) = -2140;
      HIWORD(v32) = (unsigned int)"ng work id ,err" >> 16;
      zlog(g_zc, v32, 171, "packet_2_nonce_kas", 18, 275, 40, s);
    }
    return 11;
  }
  else
      ...
      if ( v18 != -1 )
      {
        ...
        *a4 = 1;
        ...
        if ( v33 <= 0 )
        {
          ...
          v36 = 0;
LABEL_33:
          *(_QWORD *)&dword_1A3E20[v44 + 20] = v36;
          return 0;
        }
        v34 = *(_DWORD *)(a1 + 472);
        v35 = 0;
        ...
        v43 = v37;
        v44 = 2 * v60;
        v45 = *(_QWORD *)&dword_1A3E20[2 * v60 + 20];
        if ( v45 >= v36 )
        {
          LOWORD(v46) = 16112;
        }
        ...
        {
          LOWORD(v46) = (unsigned __int16)&unk_1A3EF0;
          if ( v36 - v45 <= 0x63 )
          {
            v47 = 0;
            HIWORD(v46) = (unsigned int)&unk_1A3EF0 >> 16;
            v48 = s;
            do
            {
              v50 = *(_QWORD *)v48;
...
LABEL_31:
    ...
    LOWORD(v55) = -2140;
    HIWORD(v55) = (unsigned int)"ng work id ,err" >> 16;
    zlog(g_zc, v55, 171, "packet_2_nonce_kas", 18, v54, 20, s);
    return 12;
  }
}
