int __fastcall work_2_packet_kda(int a1, int a2, int a3, _DWORD *a4)
{
  ...
  *(_BYTE *)(a3 + 6) = v24;
  ...
  if ( !v28 )
  {
    V_LOCK();
    LOWORD(v33) = -23160;
    HIWORD(v33) = (unsigned int)"p %02x, core %02x, reg %02x, clk_delay %08x" >> 16;
    LOWORD(v34) = 19788;
    ...
    do
    {
      ...
      HIWORD(v34) = (unsigned int)"ual(%d, %d), fd %d" >> 16;
    ...
    do
    {
      ...
      HIWORD(v37) = (unsigned int)"ual(%d, %d), fd %d" >> 16;
      snprintf(&v47[v40], 4096 - v40, v37, v41);
      v40 += 2;
    }
    while ( v38 != v39 );
    V_LOCK();
    logfmt_raw((char *)v48, 0x1000u, 0, 1507184, v45, v46);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-origin"
    ...
    V_LOCK();
    LOWORD(v42) = -22928;
    HIWORD(v42) = (unsigned int)"d! chip_id:%d" >> 16;
