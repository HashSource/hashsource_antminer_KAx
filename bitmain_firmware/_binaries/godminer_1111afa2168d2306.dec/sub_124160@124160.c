unsigned int __fastcall sub_124160(unsigned int *a1, char a2, char a3, _BYTE *a4, int a5)
{
  unsigned int v5; // r4
  unsigned int v7; // r8
  unsigned int v8; // r9
  ...
  *((_BYTE *)a1 + v5) = (128 >> a3) | a2 & -(128 >> a3);
  ...
  while ( 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v20 == 8 )
        break;
      v152 = dword_180378[v20];
      v23 = dword_180398[v20];
    }
    v60 = 0;
    v155 = v22;
    v165 = v25;
    ...
    while ( 1 )
    {
      ...
      if ( v60 == 8 )
        break;
      v153 = dword_1803B8[v60];
      v61 = dword_1803D8[v60];
    }
    v100 = 0;
    v190 = v62;
    v192 = v63;
    ...
    while ( 1 )
    {
      ...
      if ( v100 == 8 )
        break;
      v154 = dword_1803F8[v100];
      v101 = dword_180418[v100];
    }
    v182 = v104;
    v184 = v105;
    v178 = v102;
