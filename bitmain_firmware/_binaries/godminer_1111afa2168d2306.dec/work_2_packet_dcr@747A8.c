int __fastcall work_2_packet_dcr(int a1, _DWORD *a2, _BYTE *a3, _DWORD *a4)
{
  ...
  *v8 = (v22 + 1) & 0x7F;
  ...
  if ( !memcmp(&last_header_dcr, v10, 0xB4u) )
  {
    V_LOCK();
    LOWORD(v29) = -23160;
    HIWORD(v29) = (unsigned int)"p %02x, core %02x, reg %02x, clk_delay %08x" >> 16;
  ...
  *a4 = 186;
  ...
  V_LOCK();
  LOWORD(v25) = -22912;
  HIWORD(v25) = (unsigned int)"Pass" >> 16;
  logfmt_raw((char *)v32, 0x1000u, 0, v25, "ChipSetting_bridge_reset_DCR_1727", 68);
  V_UNLOCK();
  LOWORD(v26) = -23376;
  HIWORD(v26) = (unsigned int)"k: %s" >> 16;
  zlog(g_zc, v26, 150, "ChipSetting_bridge_reset_DCR_1727", 33, 167, 20, v32);
  v32[1] = 0;
  v33 = 0;
  v34 = 0;
  v27 = *(void (__fastcall **)(int, _DWORD *))(a1 + 276);
  LOBYTE(v33) = 1;
  v32[0] = 2;
  HIWORD(v33) = 68;
  v27(a1, v32);
