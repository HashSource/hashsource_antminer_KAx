int __fastcall phy_internal_bist(int a1, int a2, unsigned int a3, int a4)
{
  ...
  zlog(g_zc, v10, 174, "phy_internal_bist", 17, 1787, 0x14u, v65);
  v37 = malloc(0x600u);
  ...
  if ( check_core_reg_with_expect_data(a1, a2, a3, 83, 0) )
  {
    ...
    zlog(g_zc, v16, 174, "phy_handshake", 13, 1744, 100, v65);
  }
  phy_pll_switch(a1, a2, a3, a4);
  sub_7FA14(a1, a3, 98, -1426085121);
  usleep(0x64u);
  ...
  sub_7FA14(a1, a3, 133, 255);
  usleep(0x64u);
  sub_7FA14(a1, a3, 134, 255);
  usleep(0x64u);
  sub_7FA14(a1, a3, 132, -2147483647);
  sleep(6u);
