int __fastcall eeprom_rewrite_one_chain(unsigned int a1, int a2, int a3, int a4)
{
  ...
  if ( !sub_C5514(v53, v45) || !sub_C43B0(v53, (unsigned __int8 *)v45) )
  {
LABEL_6:
    *(_BYTE *)(a2 + a1 + 64) = 0;
  ...
  if ( v34 )
  {
    ...
    while ( 1 )
    {
      ...
      else
      {
        ...
        if ( sub_C5514(v53, (int)v9) && sub_C43B0(v53, v9) )
        {
          *(_BYTE *)(v44 + 64) = 1;
          return v8;
        }
        ...
        *(_BYTE *)(v44 + 64) = v46;
        ...
        v37 = g_zc;
        v38 = 958;
        LOWORD(v39) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot"
                                        "/tmp/release/build/godminer-origin_godminer-new/backend/device/hal/eeprom/bitmain_eeprom.c";
      }
      HIWORD(v39) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/r"
                                  "elease/build/godminer-origin_godminer-new/backend/device/hal/eeprom/bitmain_eeprom.c" >> 16;
      zlog(v37, v39, 170, "eeprom_rewrite_one_chain", 24, v38, 100, v57);
LABEL_43:
      if ( !--v36 )
        return v8;
    }
