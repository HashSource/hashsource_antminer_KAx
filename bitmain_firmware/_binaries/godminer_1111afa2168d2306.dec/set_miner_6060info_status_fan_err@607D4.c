int __fastcall set_miner_6060info_status_fan_err(int a1, int a2)
{
  ...
  if ( a1 > 7 )
  {
    V_LOCK();
    LOWORD(v10) = -32136;
    HIWORD(v10) = (unsigned int)"%s hw %llu" >> 16;
    logfmt_raw((char *)v13, 0x1000u, 0, v10);
    V_UNLOCK();
    LOWORD(v11) = -32308;
    HIWORD(v11) = (unsigned int)"%s" >> 16;
    v3 = 0;
    zlog(g_zc, v11, 169, "set_miner_6060info_status_fan_err", 33, 63, 40, v13);
  }
  else
  {
    v3 = a1;
  ...
  if ( a2 )
  {
    ...
    *((_DWORD *)v4 + 7) = v13[0].tv_sec;
    if ( !v6 )
    {
      ...
      {
        LOWORD(v7) = -31988;
        HIWORD(v7) = (unsigned int)"cmd : get miner type[%d] %s" >> 16;
        ...
        zlog(g_zc, v9, 169, "set_miner_6060info_status_fan_err", 33, 66, 100, v13);
        LOBYTE(a2) = v4[24];
      }
    }
  }
