int __fastcall stratum_thread(int a1)
{
  ...
  {
    V_LOCK();
    logfmt_raw(v37, 0x1000u, 0, 1347724, v4->__kind);
    V_UNLOCK();
    zlog(
      g_zc,
    ...
    V_LOCK();
    v6 = syscall(224);
    logfmt_raw(v37, 0x1000u, 0, 1345160, v5, v6);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-origin"
      ...
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          while ( 1 )
          {
            ...
            logfmt_raw(v37, 0x1000u, 0, 1347788, lock, owner, *current_pool);
            V_UNLOCK();
            zlog(
              g_zc,
...
LABEL_11:
          ...
          logfmt_raw(v37, 0x1000u, 0, v28, v27[0], v27[1], v27[2], v27[3], v27[4], v27[5], v27[6], v28, 1347836);
          V_UNLOCK();
          zlog(
            g_zc,
...
LABEL_19:
          ...
          logfmt_raw(v37, 0x1000u, 0, v36, v29, v30, v31, v32, v33, v34, v35, v36, 1347864);
          V_UNLOCK();
          zlog(
            g_zc,
            "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-"
  ...
  V_LOCK();
  V_INT((int)&v29, "poolno", v4->__lock);
  logfmt_raw(v37, 0x1000u, 0, v36, v29, v30, v31, v32, v33, v34, v35, v36, 1347896);
  V_UNLOCK();
  zlog(
    g_zc,
