...
LABEL_18:
  ...
  if ( v3 )
  {
    ...
    LOWORD(v17) = 19788;
    v16 = &s2[v3 - 1];
    HIWORD(v17) = (unsigned int)"ual(%d, %d), fd %d" >> 16;
    v18 = (char *)v12;
    v29 = v16;
    do
    {
      ...
      v21 = v11;
      v11 += 2;
      sprintf(v21, v17, *(unsigned __int8 *)(a1[125] + v7 + v15 - s2));
      v22 = v18;
      v18 += 2;
      sprintf(v22, v17, *(unsigned __int8 *)(a1[125] + v25 + v15 - s2));
    }
    while ( v15 != v29 );
  }
  V_LOCK();
  ...
  zlog(g_zc, v24, 150, "platform_check_repeat_nonce", 27, 101, 20, v33);
LABEL_17:
  free(ptr);
  if ( v26 )
    goto LABEL_18;
