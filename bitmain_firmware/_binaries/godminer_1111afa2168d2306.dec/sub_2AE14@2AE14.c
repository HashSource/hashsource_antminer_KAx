int __fastcall sub_2AE14(_DWORD *a1, int a2)
{
  ...
  else
  {
    ...
    LODWORD(v15) = sub_145954(total_accepted);
    v70 = v11 * v9;
    v16 = v15;
    if ( v9 != 0.0 )
      v16 = v15 / v9;
    ...
    if ( v20 )
    {
      sub_145954((__int64)(v10 * v9 * 100.0));
      v65 = json_real();
      json_object_set_new(v7, "GHS 5s", v65);
      sub_145954((__int64)(v17 * 100.0));
      v66 = json_real();
      json_object_set_new(v7, "GHS av", v66);
      sub_145954((__int64)(v70 * 100.0));
    }
    else
    {
      sub_145954((__int64)(v13 * v9 * 100.0));
      v21 = json_real();
      json_object_set_new(v7, "GHS 5s", v21);
      sub_145954((__int64)(*(float *)&v9 * v17 * 100.0));
      v22 = json_real();
      json_object_set_new(v7, "GHS av", v22);
      sub_145954((__int64)(*(float *)&v9 * v70 * 100.0));
    }
    v23 = json_real();
    ...
    if ( v68 + total_diff1 )
    {
      LODWORD(v63) = sub_145944(v68);
      HIDWORD(v63) = v62;
      LODWORD(v64) = sub_145944(v67);
      sub_145954((__int64)(v63 / v64 * 100.0));
    }
    v42 = json_real();
    json_object_set_new(v7, "Device Hardware%", v42);
    if ( total_diff1 )
    {
      LODWORD(v43) = sub_145954(total_diff1);
      sub_145954((__int64)(total_diff_rejected / v43 * 100.0));
    }
    v44 = json_real();
