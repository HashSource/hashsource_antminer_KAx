int __fastcall chip_setting_ticket_mask_ltc(_DWORD *a1, unsigned int a2)
{
  ...
  V_LOCK();
  LOWORD(v4) = 4780;
  HIWORD(v4) = (unsigned int)"tus_RVN" >> 16;
  ...
  v19 = v6;
  v20 = 1;
  v7 = (void (__fastcall *)(_DWORD *, unsigned int *))a1[70];
  v18 = 0;
  v7(a1, &v16);
  usleep(0x3E8u);
  v8 = a1[89];
  ...
  v19 = v8;
  v18 = 0;
  v9 = ((int (__fastcall *)(_DWORD *, unsigned int *))a1[70])(a1, &v16);
  if ( (a2 & 1) != 0 )
  {
    for ( i = 0; ; ++i )
    {
  ...
  V_LOCK();
  LOWORD(v11) = 4812;
  HIWORD(v11) = (unsigned int)"tus_RVN" >> 16;
