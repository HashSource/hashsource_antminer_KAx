int __fastcall get_theory_hashrate_eth(int a1, double *a2)
{
  ...
  if ( is_eeprom_loaded() )
  {
    LODWORD(v4) = api_get_eeprom_nonce_response_rate(*(_DWORD *)(a1 + 248), &v14);
    if ( LODWORD(v4) )
    {
      v14 = 1.0;
      V_LOCK();
      ...
      V_INT((int)v17, v8, *(int *)(a1 + 256));
      LOWORD(v9) = -13444;
      HIWORD(v9) = (unsigned int)"ist0 lost cnt: %08x" >> 16;
      logfmt_raw(v19, 0x1000u, 0, v18, v17[0], v17[1], v17[2], v17[3], v17[4], v17[5], v17[6], v18, v9);
      V_UNLOCK();
      LOWORD(v10) = -13944;
      HIWORD(v10) = (unsigned int)"rom error for getting theory_hashrate_eth!" >> 16;
      LODWORD(v4) = zlog(g_zc, v10, 171, "get_theory_hashrate_eth", 23, 1454, 100, v19);
      v5 = v14 * 1920.0;
    }
    else
    {
...
LABEL_6:
  ...
  *a2 = 1.0;
  ...
  V_INT((int)v15, v12, *(int *)(a1 + 256));
  HIWORD(v11) = (unsigned int)"t cnt failed, resp_num: %d\n" >> 16;
  ...
  zlog(g_zc, v13, 171, "get_theory_hashrate_eth", 23, 1445, 100, v19);
  return 32;
}
