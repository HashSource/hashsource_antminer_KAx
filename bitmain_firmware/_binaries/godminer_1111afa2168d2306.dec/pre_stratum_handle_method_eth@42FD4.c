  ...
  if ( v8 )
  {
    ...
    if ( !v12 && !strcasecmp(v11, "2.0") )
    {
      *(_BYTE *)(a2 + 1656) = 1;
      ...
      {
        V_LOCK();
        logfmt_raw(v29, 0x1000u, 0, 1352892, a3);
        V_UNLOCK();
        zlog(
          g_zc,
          ...
          if ( v25 )
          {
            ...
            if ( !v16 )
            {
              ...
              *(_DWORD *)(a2 + 1588) = v16;
              if ( !v16 )
              {
                printf(aInvalidPointer, 1353928);
                return v16;
              }
            }
            *(_QWORD *)(v16 + 96) = v25;
...
LABEL_35:
      ...
      {
        V_LOCK();
        logfmt_raw(v29, 0x1000u, 0, 1356764, "pre_stratum_handle_method_eth");
        V_UNLOCK();
        v16 = 0;
        zlog(
          g_zc,
...
LABEL_31:
  ...
  V_LOCK();
  logfmt_raw(v29, 0x1000u, 0, 1352756, *(_DWORD *)v27, v28);
  V_UNLOCK();
  zlog(
    g_zc,
