void bitmain_get_voltage()
{
  ...
  if ( dword_1B4604 || sub_C9384() >= 0 )
  {
    ...
    v17 = 50637397;
    v18 = 7;
    if ( sub_C89F8((void *)dword_1B4600, (unsigned __int8 *)&v17, 6u, (unsigned __int8 *)v19, 8u) )
    {
      LOWORD(v2) = 31344;
      HIWORD(v2) = (unsigned int)"itmain_tsensor.c" >> 16;
      v3 = *v2;
      v4 = v2[1];
      v5 = v2[2];
      v6 = v2[3];
      ...
      zlog(g_zc, v9, 173, "_bitmain_get_AD_conversion_N", 28, 369, 100, v28);
      LOWORD(v10) = 31372;
      HIWORD(v10) = (unsigned int)"ensor param, input num is %d" >> 16;
      v11 = *v10;
      v12 = v10[1];
      v13 = v10[2];
      v14 = v10[3];
      ...
      V_UNLOCK();
      LOWORD(v16) = 30700;
      HIWORD(v16) = (unsigned int)"sion < 0 will close power" >> 16;
      zlog(g_zc, v16, 173, "bitmain_get_voltage", 19, 705, 100, v28);
    }
    else
    {
  ...
  {
    LOWORD(v0) = 31052;
    HIWORD(v0) = (unsigned int)"rom list get error!" >> 16;
    snprintf((char *)&s, 0x800u, v0, "bitmain_get_voltage");
    V_LOCK();
    logfmt_raw(v28, 0x1000u, 0, &s);
    V_UNLOCK();
    LOWORD(v1) = 30700;
    HIWORD(v1) = (unsigned int)"sion < 0 will close power" >> 16;
    zlog(g_zc, v1, 173, "bitmain_get_voltage", 19, 701, 100, v28);
  }
}
