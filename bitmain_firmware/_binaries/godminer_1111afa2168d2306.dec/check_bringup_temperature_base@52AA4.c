int __fastcall check_bringup_temperature_base(int a1)
{
  ...
  if ( ptr )
  {
    ...
    HIWORD(v13) = (unsigned int)", sweep_level_freq: %d  sweep_matrix:\n%s" >> 16;
    v49 = 0;
    v51 = 0;
    s = v12;
    v63 = v13;
...
LABEL_29:
          if ( v6 > 0 )
          {
            ...
            v62 = 0;
            HIWORD(v27) = (unsigned int)"%d  sweep_matrix:\n%s" >> 16;
            v58 = v26;
            v60 = v27;
            v56 = 255;
            while ( 1 )
...
LABEL_58:
                V_LOCK();
                LOWORD(v44) = -10924;
                HIWORD(v44) = (unsigned int)"start to check asic num test loop" >> 16;
                logfmt_raw(v80, 0x1000u, 0, v44);
                V_UNLOCK();
                LOWORD(v45) = -11348;
                HIWORD(v45) = (unsigned int)"ck it, and reboot system" >> 16;
                zlog(g_zc, v45, 166, "check_bringup_temperature_base", 30, 273, 100, v80);
                while ( 1 )
                  ;
              }
            }
...
LABEL_35:
              ...
              {
                V_LOCK();
                V_INT((int)v72, v58, *(int *)(*(_DWORD *)v28 + 256));
              ...
              {
                V_LOCK();
                V_INT((int)v74, v58, *(int *)(*(_DWORD *)v28 + 256));
            ...
            if ( v34 == 1 )
            {
              ...
              {
                V_LOCK();
                V_INT((int)v76, v58, *(int *)(*(_DWORD *)v28 + 256));
...
LABEL_53:
                LOWORD(v42) = -11348;
                HIWORD(v42) = (unsigned int)"ck it, and reboot system" >> 16;
...
LABEL_57:
    ...
    while ( 1 )
    {
      ...
      if ( *v15 != -64 )
      {
        v18 = *(_DWORD *)(*(_DWORD *)(all_created_runtime[v16] + 404) + v14 + 12);
        if ( !v18 )
        {
          v19 = &v80[4 * v49++];
          *((_DWORD *)v19 - 128) = v17;
          V_LOCK();
          V_INT((int)v68, s, *(int *)(all_created_runtime[v16] + 256));
          LOWORD(v20) = -10984;
          HIWORD(v20) = (unsigned int)"erage_freq: %.2f, sweep_level_freq: %d  sweep_matrix:\n%s" >> 16;
...
LABEL_23:
          LOWORD(v23) = -11348;
          HIWORD(v23) = (unsigned int)"ck it, and reboot system" >> 16;
        ...
        if ( v18 == 1 )
        {
          ...
          *((_DWORD *)v43 - 64) = v17;
          V_LOCK();
          V_INT((int)v70, s, *(int *)(all_created_runtime[v16] + 256));
...
LABEL_19:
  ...
  LOWORD(v46) = -11000;
  LOWORD(v47) = 32664;
  HIWORD(v46) = (unsigned int)"eq: %d, sweep_average_freq: %.2f, sweep_level_freq: %d  sweep_matrix:\n%s" >> 16;
  HIWORD(v47) = (unsigned int)" DOAROA LOG" >> 16;
  printf(v47, v46);
  return 3;
}
