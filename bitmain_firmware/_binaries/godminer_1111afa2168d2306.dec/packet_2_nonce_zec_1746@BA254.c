int __fastcall packet_2_nonce_zec_1746(int a1, _BYTE *a2, int a3, _BYTE *a4, _DWORD *a5, unsigned int *a6, _DWORD *a7)
{
  ...
  if ( v11 > 5 )
  {
    V_LOCK();
    LOWORD(v16) = 19624;
    HIWORD(v16) = (unsigned int)"device/hal/drv_pic/mps2973.c" >> 16;
    logfmt_raw(var1004, 0x1000u, 0, v16, "packet_2_nonce_zec_1746", v12);
    V_UNLOCK();
    LOWORD(v17) = 19016;
    HIWORD(v17) = (unsigned int)", type %d, diff %d, ticket mask %d" >> 16;
    ...
    if ( v14 == 15 )
    {
      ...
      do
      {
        ...
        if ( __PAIR64__(HIBYTE(v55), (unsigned __int8)v55) != __PAIR64__(v20[90], v20[89]) )
        {
          V_LOCK();
          LOWORD(v21) = 19648;
          HIWORD(v21) = (unsigned int)"73.c" >> 16;
          logfmt_raw(
            var1004,
            0x1000u,
            0,
          ...
          V_UNLOCK();
          LOWORD(v22) = 19016;
          HIWORD(v22) = (unsigned int)", type %d, diff %d, ticket mask %d" >> 16;
      ...
      for ( i = 0; i != 16; ++i )
      {
        ...
        if ( (v26 & 0xF) != i )
        {
          V_LOCK();
          LOWORD(v27) = 19696;
          HIWORD(v27) = (unsigned int)"rite iic err" >> 16;
...
LABEL_15:
      ...
      do
      {
        ...
        if ( v32 != *(unsigned __int8 *)(v19 + 1) )
        {
          V_LOCK();
          LOWORD(v34) = 19724;
          HIWORD(v34) = (unsigned int)"err" >> 16;
          logfmt_raw(
            var1004,
            0x1000u,
            0,
      ...
      do
      {
        ...
        if ( v37 != *(unsigned __int8 *)(v19 + 2) )
        {
          V_LOCK();
          LOWORD(v39) = 19760;
          HIWORD(v39) = (unsigned int)"get_chain_mps_voltage not equal(%d, %d), fd %d" >> 16;
          logfmt_raw(
            var1004,
            0x1000u,
            0,
      ...
      do
      {
        ...
        if ( v41 != *(unsigned __int8 *)(v19 + 3) )
        {
          ...
          V_LOCK();
          LOWORD(v43) = 19796;
          HIWORD(v43) = (unsigned int)"%d), fd %d" >> 16;
          logfmt_raw(
            var1004,
            0x1000u,
            0,
