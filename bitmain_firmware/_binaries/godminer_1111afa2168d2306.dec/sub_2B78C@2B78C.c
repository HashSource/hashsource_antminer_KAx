int __fastcall sub_2B78C(_DWORD *a1, const char **a2)
{
  ...
  else
  {
    ...
    if ( v16 )
    {
      sub_145954((__int64)(v9 * v7 * 100.0));
      v90 = json_real();
      v18 = v14;
      json_object_set_new(v14, "rate_5s", v90);
      sub_145954((__int64)(v13 * 100.0));
    }
    else
    {
      sub_145954((__int64)(v10 * v7 * 100.0));
      v17 = json_real();
      json_object_set_new(v14, "rate_5s", v17);
      v12 = *(float *)&v7 * v12;
      sub_145954((__int64)(*(float *)&v7 * v13 * 100.0));
      v18 = v14;
    }
    v19 = json_real();
    json_object_set_new(v18, "rate_avg", v19);
    sub_145954((__int64)(v12 * 100.0));
    v20 = json_real();
    json_object_set_new(v18, "rate_30m", v20);
    sub_145954((__int64)(v100 * 100.0));
    v21 = json_real();
    ...
    if ( v11 + total_diff1 )
    {
      LODWORD(v74) = sub_145944(v11);
      HIDWORD(v74) = v73;
      LODWORD(v75) = sub_145944(v30);
      sub_145954((__int64)(v74 / v75 * 100.0 * 10000.0));
    }
    v31 = json_real();
    ...
    if ( v99 > 0 )
    {
      ...
      while ( 1 )
      {
        ...
        sub_145954((__int64)v38);
        v39 = json_real();
        json_object_set_new(v33, "rate_ideal", v39);
        sub_145954((__int64)(v37 * v7 * 100.0));
        v40 = json_real();
...
LABEL_36:
        ...
        v67 = *((_QWORD *)v32 + 10);
        if ( opt_algo == 9 )
          LODWORD(v67) = sub_145C6C(v67, 0x3E8u);
