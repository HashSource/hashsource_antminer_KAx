int __fastcall stratum_authorize_rvn(int a1, int *a2, void *a3)
{
  ...
  while ( 1 )
  {
    ...
    {
      V_LOCK();
      logfmt_raw(v42, 0x1000u, 0, 1353172);
      V_UNLOCK();
      zlog(
        g_zc,
...
LABEL_3:
    ...
    if ( v6 )
    {
      ...
      if ( v19 || *v30 == 6 )
      {
        ...
        logfmt_raw(v42, 0x1000u, 0, v39, v32, v33, v34, v35, v36, v37, v38, v39, 1357048, v27);
        V_UNLOCK();
        zlog(
          g_zc,
...
LABEL_36:
        ...
        if ( !v29 )
        {
          ...
          if ( v28 )
          {
            ...
            V_LOCK();
            logfmt_raw(v42, 0x1000u, 0, 1353220, v16, v31);
            V_UNLOCK();
            zlog(
              g_zc,
...
LABEL_5:
          ...
          V_LOCK();
          v8 = 0;
          logfmt_raw(v42, 0x1000u, 0, 1353220, 0, v31);
          V_UNLOCK();
          zlog(
            g_zc,
...
LABEL_27:
      ...
      else
      {
        ...
        logfmt_raw(v42, 0x1000u, 0, v39, v32, v33, v34, v35, v36, v37, v38, v39, 1357048, v21);
        V_UNLOCK();
        zlog(
          g_zc,
          "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-or"
    ...
    {
      V_LOCK();
      logfmt_raw(v42, 0x1000u, 0, 1352756, *(_DWORD *)v40, v41);
      V_UNLOCK();
      zlog(
        g_zc,
        "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/release/build/godminer-orig"
