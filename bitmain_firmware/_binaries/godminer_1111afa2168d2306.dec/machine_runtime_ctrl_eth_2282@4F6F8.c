void *machine_runtime_ctrl_eth_2282()
{
  ...
  if ( v0 )
  {
    LOWORD(v2) = -2348;
    LOWORD(v3) = -2348;
    HIWORD(v2) = (unsigned int)calc_startup_fan_pwm_eth_2282 >> 16;
    LOWORD(v4) = 12612;
    HIWORD(v3) = (unsigned int)calc_startup_fan_pwm_eth_2282 >> 16;
    ...
    LOWORD(v3) = -2340;
    LOWORD(v4) = 13876;
    HIWORD(v3) = (unsigned int)&loc_4F6E4 >> 16;
    ...
    v8[7] = v4;
    LOWORD(v4) = 10424;
    HIWORD(v3) = (unsigned int)&flt_54BF4 >> 16;
