int __fastcall stratum_handle_method_eth_2282(int (__fastcall **a1)(_DWORD, _DWORD, _DWORD), int a2, int a3)
{
  ...
  if ( v5 )
  {
    ...
    LOWORD(v9) = -23456;
    v10 = v8;
    HIWORD(v9) = (unsigned int)"nd failed" >> 16;
    ...
    if ( *(_BYTE *)(a2 + 1656) )
    {
      ...
      if ( !v13 )
        goto LABEL_7;
      v30 = sub_43FF0(v11, a2);
      goto LABEL_23;
    }
    LOWORD(v18) = -23472;
    HIWORD(v18) = (unsigned int)"tum_subscribe send failed" >> 16;
    v19 = (_DWORD *)json_object_get(v6, v18);
    v20 = (const char *)json_string_value(v19);
    if ( v20 )
    {
      LOWORD(v21) = -23464;
      HIWORD(v21) = (unsigned int)"cribe send failed" >> 16;
      v22 = json_object_get(v6, v21);
      if ( !v22 )
      {
        LOWORD(v32) = -23456;
        HIWORD(v32) = (unsigned int)"nd failed" >> 16;
      ...
      {
        LOWORD(v27) = -19500;
        HIWORD(v27) = (unsigned int)"et_eth_2282" >> 16;
          ...
          if ( !v35 )
          {
            ...
            *(_DWORD *)(a2 + 1588) = v35;
            if ( !v35 )
            {
              LOWORD(v36) = -22328;
              LOWORD(v37) = 32664;
              HIWORD(v36) = (unsigned int)"lease/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/frontend/frontend_dash/frontend_dash.c" >> 16;
              HIWORD(v37) = (unsigned int)" DOAROA LOG" >> 16;
              printf(v37, v36);
              return v12;
            }
          }
      ...
      LOWORD(v24) = -23432;
      HIWORD(v24) = (unsigned int)"cribe timed out" >> 16;
      if ( !strcasecmp(v20, v24)
        || (LOWORD(v33) = -23408, HIWORD(v33) = (unsigned int)" reason)" >> 16, !strcasecmp(v20, v33)) )
      {
        v12 = a1[14](a1, a2, v22);
        goto LABEL_8;
      }
      LOWORD(v34) = -23388;
      HIWORD(v34) = (unsigned int)" call failed: %s, req_id=%d" >> 16;
...
LABEL_7:
  ...
  V_LOCK();
  LOWORD(v25) = -23500;
  HIWORD(v25) = (unsigned int)"GodMiner/2.0.1\", null]}" >> 16;
  ...
  zlog(g_zc, v26, 174, "stratum_handle_method_eth_2282", 30, 702, 100, v40);
  return 0;
}
