int __fastcall stratum_subscribe_base(int a1, int *a2)
{
  ...
  do
  {
    ...
    if ( !(*(int (__fastcall **)(int *, _BYTE *))(a1 + 12))(a2, v10) )
    {
      ...
      v13 = 190;
      v14 = g_zc;
      LOWORD(v15) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/t"
                                      "mp/release/build/godminer-origin_godminer-new/frontend/frontend_base.c";
LABEL_11:
      HIWORD(v15) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/tmp/r"
                                  "elease/build/godminer-origin_godminer-new/frontend/frontend_base.c" >> 16;
