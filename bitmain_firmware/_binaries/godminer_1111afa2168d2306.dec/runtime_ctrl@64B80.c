...
LABEL_3:
    ...
    default:
      V_LOCK();
      LOWORD(v5) = -29784;
      HIWORD(v5) = (unsigned int)"Rx: %s" >> 16;
      v1 = 0;
      logfmt_raw(v9, 0x1000u, 0, v5, a1);
      V_UNLOCK();
      LOWORD(v6) = -29836;
      LOWORD(v7) = -29744;
      HIWORD(v6) = (unsigned int)"ner-origin_godminer-new/backend/uart_debug_logger.c" >> 16;
      HIWORD(v7) = (unsigned int)"se_asic" >> 16;
      zlog(g_zc, v7, 155, v6, 12, 65, 100, v9);
      break;
  }
  return v1;
}
