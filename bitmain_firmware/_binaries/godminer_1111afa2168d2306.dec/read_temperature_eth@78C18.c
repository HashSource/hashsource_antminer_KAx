int __fastcall read_temperature_eth(int a1, int *a2)
{
  ...
  if ( v2 > 0 )
  {
    ...
    for ( i = a2; v20 != i; i += 2 )
    {
      ...
      LOWORD(v14) = -13944;
      HIWORD(v14) = (unsigned int)"rom error for getting theory_hashrate_eth!" >> 16;
      zlog(g_zc, v14, 171, "read_temperature_eth", 20, v13, 100, v33);
      v6 = v21;
LABEL_4:
      *i = v6;
      v7 = v3[1];
...
LABEL_11:
        ...
        zlog(g_zc, v16, 171, "read_temperature_eth", 20, v15, 100, v33);
        v12 = v22;
        goto LABEL_6;
      }
      v12 = v22;
