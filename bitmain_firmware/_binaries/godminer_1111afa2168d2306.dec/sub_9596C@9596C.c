unsigned int *__fastcall sub_9596C(unsigned int *result)
{
  float v1; // s0
  int v2; // r8
  float v3; // s11
            ...
            *result = v7 & 7 | (v2 << 8) | 0xC0000000 | v4 | (v11 << 16) | ((v12 > 2400.0) << 28);
            ...
            if ( fabsf(v13 - v1) < 3.0 )
            {
              ...
              return (unsigned int *)zlog(
                                       g_zc,
                                       "/workspace/jenkins/jenkins/workspace/Antminer_KA3_release/build/rootfs/buildroot/"
                                       "tmp/release/build/godminer-origin_godminer-new/backend/chip_setting.c",
                                       150,
                                       "inferred_plldivider",
                                       19,
                                       636,
